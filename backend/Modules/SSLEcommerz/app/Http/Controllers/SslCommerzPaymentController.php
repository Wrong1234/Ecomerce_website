...
//                 'payment_gateway_url' => $payment_options,
//                 'instructions' => 'Copy the payment_gateway_url and open it in a browser to complete payment'
//             ]
//         ], 200);
//     } else {
//         return response()->json([
