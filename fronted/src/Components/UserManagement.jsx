...
// const users = [
//     { name: "Alice Johnson", email: "alice@email.com", role: "Admin" },
//     { name: "Bob Smith", email: "bob@email.com", role: "User" },
//     { name: "Charlie Brown", email: "charlie@email.com", role: "Moderator" },
// ];
...
//             if(!response.ok){
//                 console.log("Data fetch error check url and fix them");
//             }
...
//                 <h1 className="text-3xl font-bold mb-6 text-gray-800 pt-3 text-center">User Management</h1>
...
//                         <thead>
//                             <tr>
//                                 <th className="px-6 py-3 text-center text-xs font-medium text-gray-700 uppercase">Name</th>
//                             </tr>
//                         </thead>
//                         <tbody>
...
//                                         <td className="px-6 py-4 whitespace-nowrap font-medium text-gray-900 no-underline">
//                                             {user.name}
//                                         </td>
//                                         </NavLink>
//                                     </tr>
